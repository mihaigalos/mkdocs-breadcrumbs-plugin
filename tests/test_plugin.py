...
# Make sure we can import the plugin module
...
class TestBreadcrumbsPlugin(unittest.TestCase):
    ...
    def test_on_page_markdown(self):
        ...
        result = self.plugin.on_page_markdown(markdown, self.page, self.mkdocs_config, None)
    ...
    def test_is_path_excluded(self):
        ...
        self.assertTrue(self.plugin._is_path_excluded('/tmp/docs/test_dir/subdir/file.md'))
    ...
    def test_homepage_handling(self):
        ...
        result = self.plugin.on_page_markdown(markdown, homepage, self.mkdocs_config, None)
    ...
    def test_section_page_with_titles(self):
        ...
        result = self.plugin.on_page_markdown(markdown, section_page, self.mkdocs_config, None)
    ...
    def test_nested_pages_url_based(self):
        ...
        result = self.plugin.on_page_markdown(markdown, nested_page, self.mkdocs_config, None)
